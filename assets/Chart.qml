    ...
    Page {
        actions: [
            ...
            InvokeActionItem {
                ...
                onTriggered: {
                    data = app.encodeQString(qsTr("shareChart"))
                }
            }
        ]
        Container {
        ...
        attachedObjects: [
            ComponentDefinition {
                ...
                Page {
                    ...
                    WebView {
                        id: graph1
                        url: "local:///assets/chart/pie.html"
            ...
            ComponentDefinition {
                ...
                Page {
                    ...
                    WebView {
                        id: graph2
                        url: "local:///assets/chart/lines.html"
                        minWidth: DisplayInfo.width
                        minHeight: DisplayInfo.height
                    }
                }
            ...
            ComponentDefinition {
                ...
                Page {
                    ...
                    WebView {
                        id: graph3
                        url: "local:///assets/chart/bars.html"
                        minWidth: DisplayInfo.width
                        minHeight: DisplayInfo.height
                    }
                }
